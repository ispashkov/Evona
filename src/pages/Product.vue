            ...
            div.col-8.col-hd-7
                div.row
                    div.col.d-flex
                        ...
                        carousel(:step='0' :images='images' :items='8' @currentSlide='currentSlide' :vertical='true')
                    ...
                    div.col
                        ...
                        h1.heading.heading_h2.product__title Платье EN5312L.0130(90)

                        div.product-properties
                            div.product-properties-item
                                span.label.product-properties__label Бренд:
                                =" "
                                span.product-properties__value Evona
